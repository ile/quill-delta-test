(function () {
	...
	var Op_1$1 = __importDefault(Op_1);
	...
	function () {
	  ...
	  Iterator.prototype.next = function (length) {
	    ...
	    if (nextOp) {
	      ...
	      var opLength = Op_1$1.default.length(nextOp);
	...
	var Iterator_1$1 = __importDefault(Iterator_1);

	var Op;

	(function (Op) {
	  function iterator(ops) {
	    return new Iterator_1$1.default(ops);
	  }
	...
	var Delta_1 = createCommonjsModule(function (module) {
	...
	var AttributeMap_1$1 = __importDefault(AttributeMap_1);
	...
	function () {
	  ...
	  Delta.prototype.changeLength = function () {
	    return this.reduce(function (length, elem) {
	      if (elem.insert) {
	        return length + Op_1$1.default.length(elem);
	      } else if (elem.delete) {
	  ...
	  Delta.prototype.slice = function (start, end) {
	    ...
	    var ops = [];
	    var iter = Op_1$1.default.iterator(this.ops);
	    var index = 0;
	    ...
	    while (index < end && iter.hasNext()) {
	      ...
	      index += Op_1$1.default.length(nextOp);
	    }
	  ...
	  Delta.prototype.compose = function (other) {
	    var thisIter = Op_1$1.default.iterator(this.ops);
	    var otherIter = Op_1$1.default.iterator(other.ops);
	    var ops = [];
	    ...
	    while (thisIter.hasNext() || otherIter.hasNext()) {
	      if (otherIter.peekType() === 'insert') {
	        ...
	        if (typeof otherOp.retain === 'number') {
	          ...
	          var attributes = AttributeMap_1$1.default.compose(thisOp.attributes, otherOp.attributes, typeof thisOp.retain === 'number');
	        ...
	        switch (component[0]) {
	          ...
	          case fast_diff_1.default.EQUAL:
	            ...
	            if (lodash_isequal_1.default(thisOp.insert, otherOp.insert)) {
	              retDelta.retain(opLength, AttributeMap_1$1.default.diff(thisOp.attributes, otherOp.attributes));
	            } else {
	  ...
	  Delta.prototype.eachLine = function (predicate, newline) {
	    ...
	    while (iter.hasNext()) {
	      ...
	      var start = Op_1$1.default.length(thisOp) - iter.peekLength();
	  ...
	  Delta.prototype.invert = function (base) {
	    ...
	    this.reduce(function (baseIndex, op) {
	      if (op.insert) {
	        inverted.delete(Op_1$1.default.length(op));
	        ...
	        slice.forEach(function (baseOp) {
	          if (op.delete) {
	            ...
	            inverted.retain(Op_1$1.default.length(baseOp), AttributeMap_1$1.default.invert(op.attributes, baseOp.attributes));
	          }
	        });
	  ...
	  Delta.prototype.transform = function (arg, priority) {
	    ...
	    while (thisIter.hasNext() || otherIter.hasNext()) {
	      if (thisIter.peekType() === 'insert' && (priority || otherIter.peekType() !== 'insert')) {
	        delta.retain(Op_1$1.default.length(thisIter.next()));
	        ...
	        if (thisOp.delete) {
	          ...
	          delta.retain(length_3, AttributeMap_1$1.default.transform(thisOp.attributes, otherOp.attributes, priority));
	        }
	      }
	    }
	  ...
	  Delta.Op = Op_1$1.default;
	  Delta.AttributeMap = AttributeMap_1$1.default;
	  return Delta;
	}();
	...
	class MyDelta {
	  constructor(element) {
	    this.root = element;
	    this.data = new Delta_1();
	    this.constructDelta(this.data, element);
	  }

	  update() {
	    let data = new Delta_1();
	...
	console.log('initial data', delta.data); // Add new node, do a diff
